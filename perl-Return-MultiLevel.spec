...
Version  : 0.06
Release  : 22
URL      : https://cpan.metacpan.org/authors/id/P/PL/PLICEASE/Return-MultiLevel-0.06.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/P/PL/PLICEASE/Return-MultiLevel-0.06.tar.gz
...
%prep
%setup -q -n Return-MultiLevel-0.06
cd %{_builddir}
tar xf %{_sourcedir}/libreturn-multilevel-perl_0.05-1.debian.tar.xz
cd %{_builddir}/Return-MultiLevel-0.06
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Return-MultiLevel-0.06/deblicense/
